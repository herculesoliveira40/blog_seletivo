    ...
    <div class="card-header text-white bg-success"> <h2>Editar Livro</h2></div>
            ...
            <form name="cadastrar" method="POST" action="<?= URL?>/livros/editar/<?= $dados['id']?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="autor" id="autor"  class="form-control" value="<?= $dados['autor']?>" >
                </div> 
                <div class="mb-3">
                    <label for="data_de_publicacao" class="form-label"> Data de Publicação: </label>
                    <input type="date" name="data_de_publicacao" id="data_de_publicacao"  class="form-control" value="<?= $dados['data_de_publicacao']?>" >
                </div> 
                <div class="mb-3">  
                ...
                <div class="mb-3">  
                    ...
                    <input type="number" name="paginas" id="paginas"  class="form-control" value="<?= $dados['paginas']?>" >
                </div> 
                <div class="mb-3">  
